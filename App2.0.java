...
//    private JPanel p_bottom;
    private JMenuBar mb;
    private JMenu file,edit,run,help,help_sub_menu;
    private JMenuItem cut,copy,paste,selectAll,open,lang,eng,ru;
...
//        f.add(p_left);f.add(p_right);f.add(p_bottom);
    ...
    private void initScroll()
    {
        ...
        scroll.setBounds(50,50, 300,400);
        ...
        scroll_v2.setBounds(450,50, 300,400);
    }
